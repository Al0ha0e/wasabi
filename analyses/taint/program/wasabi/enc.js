...
function stringToUTF8Array(str, outU8Array, outIdx, maxBytesToWrite) {
    ...
    for (var i = 0; i < str.length; ++i) {
        ...
        if (u <= 127) {
            ...
            Wasabi.taintMemory[outIdx] = new Taint(1)
            outU8Array[outIdx++] = u
        } else if (u <= 2047) {
...
function writeArrayToMemory(array, buffer) {
    // array: source
    // buffer: where to begin writing == offset into HEAP8
    Wasabi.taintMemory[buffer] = new Taint(1)
...
function integrateWasmJS() {
    var wasmTextFile = "enc.wast";
    var wasmBinaryFile = "enc.wasm";
    var asmjsCodeFile = "enc.temp.asm.js";
