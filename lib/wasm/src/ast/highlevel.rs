...
impl Instr {
    ...
    pub fn to_tp_id(&self) -> i64 {
        ...
        match *self {
            ...
            Local(LocalSet, _) => 17,
            Local(LocalTee, _) => 18,
            Global(GlobalGet, _) => 19,
            Global(GlobalSet, _) => 20,
            MemorySize(_) => 21,
            MemoryGrow(_) => 22,
            Const(Val::I32(_)) => 23,
            Const(Val::I64(_)) => 24,
            ...
            Load(I32Load8S, _) => 31,
            Load(I32Load8U, _) => 32,
            Load(I32Load16S, _) => 33,
            Load(I32Load16U, _) => 34,
            Load(I64Load8S, _) => 35,
            Load(I64Load8U, _) => 36,
            Load(I64Load16S, _) => 37,
            Load(I64Load16U, _) => 38,
            Load(I64Load32S, _) => 39,
            Load(I64Load32U, _) => 40,
            Store(I32Store, _) => 41,
            Store(I64Store, _) => 42,
            Store(F32Store, _) => 43,
            Store(F64Store, _) => 44,
            Store(I32Store8, _) => 45,
            Store(I32Store16, _) => 46,
            Store(I64Store8, _) => 47,
            Store(I64Store16, _) => 48,
            Store(I64Store32, _) => 49,
            Numeric(I32Eqz) => 50,
            Numeric(I64Eqz) => 51,
            Numeric(I32Clz) => 52,
            Numeric(I32Ctz) => 53,
            Numeric(I32Popcnt) => 54,
            Numeric(I64Clz) => 55,
            Numeric(I64Ctz) => 56,
            Numeric(I64Popcnt) => 57,
            Numeric(F32Abs) => 58,
            Numeric(F32Neg) => 59,
            Numeric(F32Ceil) => 60,
            Numeric(F32Floor) => 61,
            Numeric(F32Trunc) => 62,
            Numeric(F32Nearest) => 63,
            Numeric(F32Sqrt) => 64,
            Numeric(F64Abs) => 65,
            Numeric(F64Neg) => 66,
            Numeric(F64Ceil) => 67,
            Numeric(F64Floor) => 68,
            Numeric(F64Trunc) => 69,
            Numeric(F64Nearest) => 70,
            Numeric(F64Sqrt) => 71,
            Numeric(I32WrapI64) => 72,
            Numeric(I32TruncF32S) => 73,
            Numeric(I32TruncF32U) => 74,
            Numeric(I32TruncF64S) => 75,
            Numeric(I32TruncF64U) => 76,
            Numeric(I64ExtendI32S) => 77,
            Numeric(I64ExtendI32U) => 78,
            Numeric(I64TruncF32S) => 79,
            Numeric(I64TruncF32U) => 80,
            Numeric(I64TruncF64S) => 81,
            Numeric(I64TruncF64U) => 82,
            Numeric(F32ConvertI32S) => 83,
            Numeric(F32ConvertI32U) => 84,
            Numeric(F32ConvertI64S) => 85,
            Numeric(F32ConvertI64U) => 86,
            Numeric(F32DemoteF64) => 87,
            Numeric(F64ConvertI32S) => 88,
            Numeric(F64ConvertI32U) => 89,
            Numeric(F64ConvertI64S) => 90,
            Numeric(F64ConvertI64U) => 91,
            Numeric(F64PromoteF32) => 92,
            Numeric(I32ReinterpretF32) => 93,
            Numeric(I64ReinterpretF64) => 94,
            Numeric(F32ReinterpretI32) => 95,
            Numeric(F64ReinterpretI64) => 96,
            Numeric(I32Eq) => 97,
            Numeric(I32Ne) => 98,
            Numeric(I32LtS) => 99,
            Numeric(I32LtU) => 100,
